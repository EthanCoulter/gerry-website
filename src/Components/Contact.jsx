                ...
                <div className="flex flex-col justify-start">
                    <form className="flex flex-col" ref={form} onSubmit={sendEmail}>
                        <div className="flex flex-col   py-2">
                            ...
                            <input type="text" className="rounded-md h-[30px]" name="name" placeholder="Your Name (First and Last)" required />
                        </div>
                        <div className="flex flex-col py-5">
                            <label htmlFor="" className="mb-2 text-white text-lg font-bold">Your email:</label>
                            <input type="text" className="rounded-md h-[30px]" name="email" placeholder="Your Email" required />
                        </div>
                        <div className="flex flex-col py-2">
                            <label htmlFor="" className="mb-2 text-white text-lg font-bold">Your Message:</label>
                            <input type="text" className="rounded-md h-[70px] text-clip" name="message" placeholder="Your Message" required />
                        </div>
