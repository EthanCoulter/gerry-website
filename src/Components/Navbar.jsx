...
const Navbar = () => {
    ...
    return (
        <div className=" flex justify-between items-center h-24 mx-auto px-4 w-full fixed text-white bg-main-brand-col">
            <h1 className="w-full drop-shadow-lg text-xl md:text-2xl lg:text-3xl font-bold text-white pointer-events-none ">G.W Counselling</h1>
            ...
            <div className={!nav ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500" : 'fixed left-[-100%]'}>
                <h1 className="w-full drop-shadow-mdtext-3xl font-bold  text-white m-4 pointer-events-none">G.W Counselling</h1>
