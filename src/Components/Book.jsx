...
const Book = () => {
    return (
        <div id="abc" className="flex flex-col-reverse  items-center  bg-light-shade md:flex-row tablet:justify-center">
            <div className="flex flex-col items-center tablet:w-[600px] tablet:pr-5">
                <div className="flex flex-col items-center pb-5 bg-main-brand-col rounded-b-lg mb-5 tablet:rounded-b-none ">
                <h1 className="text-3xl pb-4 font-serif tablet:pt-3 text-white">Textbook</h1>
