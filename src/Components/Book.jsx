...
const Book = () => {
    return (
        <div id="abc" className="flex flex-col-reverse   px-5 bg-light-shade tablet:flex-row tablet:justify-center">
            <div className="flex flex-col-reverse items-center bg-light-accent rounded-xl mb-5 tablet:p-16 tablet:flex-row tablet:justify-center ">
                <div className="flex flex-col items-center pr-0 tablet:w-[600px] tablet:pr-5">
                    <div className="flex flex-col items-center pb-5 bg-main-brand-col rounded-b-lg  tablet:rounded-b-none ">
                        <h1 className="text-3xl pb-4 font-serif pt-3 tablet:pt-3 text-white">Textbook</h1>
